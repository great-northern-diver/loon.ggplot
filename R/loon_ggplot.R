#' @title loon.ggplot
#'
#' @description A bridge between \code{loon} widgets and \code{ggplot} objects. It can take either a \code{loon} widget
...
#' @param ... arguments used in \code{loon2ggplot()} or \code{ggplot2loon()}
#'
#' @return If the input is a \code{ggplot} object, the output would be a \code{loon} widget; vice versa
#'
